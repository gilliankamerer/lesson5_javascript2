        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
                ...
                //compute tax for married file jointly calculation
                if (income <= 18550){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
...
function clearButton () {
             ...
             //This code resets the tax estimate results to nothing.
              document.getElementById("taxEstimate").innerHTML = "";
              
             //This code resets the tax bracket results to nothing.
